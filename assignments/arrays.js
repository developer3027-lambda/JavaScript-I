...
console.log(lastCar.car_make, lastCar.car_model,'is the last car');
...
// let carModelsSorted = [];
// console.log();
let carModels = []; //creates empty array
for (let i = 0; i < inventory.length; i++) { //for loop that runs through the inventory array.
  carModels.push(inventory[i].car_model); //push inserts element into array. This populates the new array called 
}                                         //carModels by running through the car_model key.
console.log(carModels.sort());            //Use the sort method on the new array and console log it
// ==== Challenge 4 ====
...
//let oldCars = carYears.filter(year => year < 2000).length;
